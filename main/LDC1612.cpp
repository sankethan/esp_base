...
void LDC1612::get_l1(bool print)
{
    ...
    uint32_t raw_value = (((uint32_t)msb_temp << 16) | lsb_temp);
    uint8_t error = (msb_temp & 0xf000) >> 12;
...
int LDC1612::sensor_status_parse(uint16_t value)
{
    ...
    {
    case 0:
        printf("Channel 0 is source of flag or error.\n");
        break;
    case 1:
        printf("Channel 1 is source of flag or error.\n");
        break;
    /*Only support LDC1614*/
    case 2:
        printf("Channel 2 is source of flag or error.\n");
        break;
    case 3:
        printf("Channel 3 is source of flag or error.\n");
        break;
    default:
        break;
    }
